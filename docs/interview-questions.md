# SRE Incident Response Interview Questions and Answers (50+)

## Beginner (1-10)

### 1. What is SRE Incident Response and why is it important in modern engineering?
**Answer:** SRE Incident Response is essential for building reliable, scalable, and automated systems. It reduces manual toil, increases deployment velocity, and ensures consistency across environments.

### 2. What are the core components of SRE Incident Response?
...
### 3. How does SRE Incident Response fit into the DevOps or ML lifecycle?
...
### 4. What are the most common challenges with SRE Incident Response?
