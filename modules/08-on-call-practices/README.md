# Module 08: On-Call Best Practices
...
- Understand the core concepts of On-Call Best Practices
...
### What is On-Call Best Practices?

On-Call Best Practices is a fundamental component of SRE Incident Response: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of On-Call Best Practices like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/08-on-call-practices/
```
...
```bash
ls modules/08-on-call-practices/lab/starter/
```
...
cd modules/08-on-call-practices/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/08-on-call-practices/validation/validate.sh
```
...
1. What is the main purpose of On-Call Best Practices?
...
- [ ] Validation script passes: `bash modules/08-on-call-practices/validation/validate.sh`
...
**Next: [Module 09 →](../09-chaos-engineering-basics/)**
